...
namespace ShoppingCartDataModelling.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CommentsController : ControllerBase
    {
        private readonly ShoppingCartDataModellingContext _context;

        public CommentsController(ShoppingCartDataModellingContext context)
        {
            _context = context;
        }
